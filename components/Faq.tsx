const faqs = [
  ...
  {
    id: "faq2",
    q: "เรียนตัวต่อตัว 10 ชั่วโมงจะพอทำเว็บได้จริงไหม?",
    a: "คอร์สนี้เป็นการสอนตัวต่อตัว 1:1 รวม 10 ชั่วโมง เน้นทำเว็บไซต์ 1 โปรเจกต์ให้จบ Workflow ตั้งแต่วาง Brief, Design Preview, Next.js, Tracking และ Deploy เพราะสอนแบบ 1:1 จึงปรับจังหวะและโฟกัสตามพื้นฐานและโจทย์ของผู้เรียนได้เต็มที่",
  },
  {
    id: "faq3",
  ...
  },
  {
    ...
    a: "Private Class คือเรียนตัวต่อตัว 1:1 รวม 10 ชั่วโมง ราคา 12,900.- เลือกวันเวลาเรียนเองได้และโฟกัสโจทย์ของผู้เรียนเต็มที่ ส่วน Group Class คือมาเรียนเป็นกลุ่มเล็กหรือกับเพื่อน เนื้อหาเดียวกันแต่มีราคาพิเศษต่อคน ทักไลน์เพื่อประเมินรอบและราคาได้เลย",
  },
  {
    id: "faq9",
